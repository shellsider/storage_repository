...
const meta: Meta<typeof HeroBanner> = {
  ...
  args: {
    fields: {
      ...
      Description: { value: '<p>With privacy at the heart of every matter, our Business Management and Family Office Practice is highly experienced and dedicated to providing sound financial and business guidance for high-profile individuals and their families.</p><p>Citrin Cooperman covers a wide range of clients, including high net worth individuals, high-profile individuals and their families, and single-family and multi-family offices.</p>' },
...
export const Variant: Story = {
  args: {
    fields: {
      Title: { value: 'Business Management and Family Office' },
      Description: { value: '<p>Alternate description for the variant.</p>' },
    },
  },
};
